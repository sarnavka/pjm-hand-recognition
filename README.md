...
Optymalna odległość: 50–80 cm od kamery (mniej więcej długość wyciągniętego ramienia). Pozycja: kamera na poziomie klatki piersiowej, jednolite tło. Idealnie: 20-40 próbek na literę nagrywane najlepiej na przestrzeni kilku dni, godzin, by ułożenie ręki było różne na każdym nagraniu, np. przez 5-10 dni do każdej litery po 5 próbek. Oczywiście dostosuj do swoich możliwości. Za każdą pomoc dziękuję <3.
